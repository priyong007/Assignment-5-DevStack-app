...
const Banner = () => {
  return (
    <div className="grid grid-cols-1 md:grid-cols-12 max-w-7xl mx-auto justify-items-center items-center gap-8 px-4 py-5">
      <div className="md:col-span-6 lg:col-span-7 text-center md:text-left">
        ...
        <div className='sm-justify-center  md:flex gap-2'>
